...
namespace BackOfficeServer.Controllers
{
    public class CustomersController : BaseController
    {
        ...
        //[HttpPost]
        //[Route("customers/{clientId}/deletedocuments/{documentId}")]
        //public Response<string> DeleteDocument(int clientId, int documentId = 0)
        //{
        //    try
        //    {
        //        log.Info(string.Format("Delete files: client id {0}, document id {1}", clientId, documentId));
        //        string documentType = string.Empty;
        //        int userId = Convert.ToInt32(HttpContext.Current.Session["UserId"]);

        //        using (var service = new BackOfficeWebServiceClient("BackOfficeWebServer.NET"))
        //        {
        //            var isDeleted = service.DeleteDocument(clientId, documentId);
        //            if (isDeleted)
        //            {
        //                log.Info(string.Format("Delete files success: client id {0}, document id {1}", clientId, documentId));
        //                return Response<string>.CreateResponse(Constants.Success, Constants.FileUploaded, null);
        //            }
        //            else
        //            {
        //                log.Info(string.Format("Delete files failed: client id {0}, document id {1}", clientId, documentId));
        //                return Response<string>.CreateResponse(Constants.Failed, null, new ErrorHandler() { ErrorCode = Constants.CustomerErrorCode, Message = Constants.DocumentUploadErrorMessage });
        //            }
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        //        log.Error(string.Format("Error deleting file: client id {0}, document id {1}\nError: {2}", clientId, documentId, ex));
        //        return Response<string>.CreateResponse(Constants.Failed, null, new ErrorHandler() { ErrorCode = Constants.CustomerErrorCode, Message = Constants.DocumentUploadErrorMessage });
        //    }
        //}

        //[HttpGet]
        //[Route("customers/{clientId}/download/{documentId}")]
        //public HttpResponseMessage downloadDocument(int clientId, int documentId)
        //{
        //    try
        //    {
        //        log.Info(string.Format("Get document"));

        //        bool exists = Directory.Exists(HttpContext.Current.Server.MapPath("~/Content/Documents/"));
        //        var file = GetFiles(clientId).Data.Where(d => d.DocumentId == documentId).FirstOrDefault();
        //        if (!exists)
        //        {
        //            log.Fatal("Directory '~/Content/Documents/' does not exist.");
        //        }

        //        FileStream stream = File.OpenRead(HttpContext.Current.Server.MapPath("~/Content/Documents/" + file.FileName));
        //        try
        //        {
        ...
        //            };
        //            result.Content.Headers.ContentDisposition = new ContentDispositionHeaderValue(System.Net.Mime.DispositionTypeNames.Inline)
        //            {
        ...
        //        catch (Exception ex)
        //        {
        //            log.Error(string.Format("Error in document Exception : {0}",ex.ToString()));
        //            throw;
        //        }
        //        finally
        //        {
        ...
        //    catch (Exception ex)
        //    {
        //        log.Error(string.Format("Error in Get document {0}\nError: {1}", documentId, ex));
        //        throw; ;
        //    }
